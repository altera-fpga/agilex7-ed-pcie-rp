...
set clk_pcie [get_clocks {soc_inst|subsys_pcie_0|intel_pcie_ftile_mcdma_dev_1|intel_pcie_ftile_mcdma_dev_1|ast_hip|intel_pcie_ftile_ast_hip|rx_clkout|ch5}]
